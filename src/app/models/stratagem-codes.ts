...
export const stratagemCodes: stratagemCode[] = [
	...
	},
	{
		...
		icon: 'guard-dog-breath',
		code: [inputDirection.Down, inputDirection.Up, inputDirection.Left, inputDirection.Up, inputDirection.Right, inputDirection.Up],
		sound: [],
		voice: equipmentPackageVoices,
		postSound: [],
		colour: 'blue',
	...
	},
	{
		name: 'Sterilizer',
		icon: 'sterilizer',
		code: [inputDirection.Down, inputDirection.Left, inputDirection.Up, inputDirection.Down, inputDirection.Left],
		sound: [],
		voice: supportWeaponVoices,
		postSound: [],
		colour: 'blue',
