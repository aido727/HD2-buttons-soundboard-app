...
export const stratagemCodes: stratagemCode[] = [
    ...
    {name: "Gatling Barrage", icon: "", code: [inputDirection.Right, inputDirection.Down, inputDirection.Left, inputDirection.Up, inputDirection.Up], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "Airburst Strike", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Right], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "120MM HE Barrage", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Down, inputDirection.Left, inputDirection.Right, inputDirection.Down], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "380MM HE Barrage", icon: "", code: [inputDirection.Right, inputDirection.Down, inputDirection.Up, inputDirection.Up, inputDirection.Left, inputDirection.Down, inputDirection.Down], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "Walking Barrage", icon: "", code: [inputDirection.Right, inputDirection.Down, inputDirection.Right, inputDirection.Down, inputDirection.Right, inputDirection.Down], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    ...
    {name: "Railcannon Strike", icon: "", code: [inputDirection.Right, inputDirection.Up, inputDirection.Down, inputDirection.Down, inputDirection.Right], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "Precision Strike", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Up], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "Gas Strike", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Down, inputDirection.Right], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "EMS Strike", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Left, inputDirection.Down], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
    {name: "Smoke Strike", icon: "", code: [inputDirection.Right, inputDirection.Right, inputDirection.Down, inputDirection.Up], sound: "", voice: "", colour: "red", deployType: "beam-only", type: "Offensive", subType: "Orbital"},
